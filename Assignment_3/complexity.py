...
from algorithms import exchange_sort_asc_alg
from algorithms import stooge_sort_alg
...
def interpolation_search_wrapper_b(arr):
    return interpolation_search(arr, 0, len(arr) - 1, arr[0])

def interpolation_search_wrapper_a(arr):
    return interpolation_search(arr, 0, len(arr) - 1, arr[(len(arr) - 1)//2])

def interpolation_search_wrapper_w(arr):
    return interpolation_search(arr, 0, len(arr) - 1, arr[len(arr) - 1])
...
def menu(a, was_sorted):
    while True:
        ...
        if o == 1:
            ...
            print("You must choose one of the options 1-8.")
...
def option_5():
    print("You chose the best case runtime analysis. Now choose the algorithm:")
    ...
    if o == 1:
        ...
        for n in sizes:
            a = list(range(1, n+1))
            elapsed_time = timeit.timeit(lambda: interpolation_search_wrapper_b(a.copy()), number=1)
            print(f"{n}-element list took {elapsed_time:.6f} seconds")

def option_6():
    print("You chose the average case runtime analysis. Now choose the algorithm:")
    print(" 1. Exchange Sort \n 2. Stooge Sort \n 3. Interpolation search \n")
    sizes = [500, 1000, 2000, 4000, 8000]
    try:
        o = int(input(""))
    ...
    if o == 1:
        ...
        for n in sizes:
            a = list(range(1, n+1))
            elapsed_time = timeit.timeit(lambda: interpolation_search_wrapper_a(a.copy()), number=1)
            print(f"{n}-element list took {elapsed_time:.6f} seconds")

def option_7():
    print("You chose the worst case runtime analysis. Now choose the algorithm:")
    print(" 1. Exchange Sort \n 2. Stooge Sort \n 3. Interpolation search \n")
    sizes = [500, 1000, 2000, 4000, 8000]
    try:
        o = int(input(""))
    ...
    if o == 1:
        ...
        for n in sizes:
            a = list(range(1, n+1))
            elapsed_time = timeit.timeit(lambda: interpolation_search_wrapper_w(a.copy()), number=1)
            print(f"{n}-element list took {elapsed_time:.6f} seconds")
